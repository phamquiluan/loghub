...
+ [**ASE'21**] Le, Van-Hoang, and Hongyu Zhang. [Log-based anomaly detection without log parsing.](https://ieeexplore.ieee.org/abstract/document/9678773) The 36th IEEE/ACM International Conference on Automated Software Engineering (ASE). IEEE, 2021.
+ [**ASE'19**] Jinyang Liu, Jieming Zhu, Shilin He, Pinjia He, Zibin Zheng, Michael R. Lyu. [Logzip: Extracting Hidden Structures via Iterative Clustering for Log Compression](https://arxiv.org/abs/1910.00409). To appear in IEEE/ACM International Conference on Automated Software Engineering (ASE), 2019.
